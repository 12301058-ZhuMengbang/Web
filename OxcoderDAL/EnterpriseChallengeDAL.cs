...
namespace OxcoderDAL
{
    public class EnterpriseChallengeDAL:OxcoderIDAL.EnterpriseChallengeIDAL
    {
        ...
        public bool AddChallenge(Model.Challenge chlg)
        {
            ...
            par[12].Value = new Guid(chlg.Challenge_Quiz.ToString().Split(',')[2]);
            par[13].Value = new Guid(chlg.Challenge_Quiz.ToString().Split(',')[3]);
            par[14].Value = new Guid(chlg.Challenge_Quiz.ToString().Split(',')[1]);
